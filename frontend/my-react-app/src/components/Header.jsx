...
const Header = ({ user, onLogout }) => {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation Menu - Moved outside header to avoid stacking issues */}
      <AnimatePresence>
        {isMenuOpen && (
          <div className="fixed inset-0 z-[999] md:hidden">
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-green-900/40 backdrop-blur-md"
            />
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-[85%] max-w-[320px] bg-white shadow-2xl flex flex-col overflow-hidden"
            >
