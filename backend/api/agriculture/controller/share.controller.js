...
const trackShare = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: `📢 Link Shared on ${platform} by ${userName}! (Total: ${totalShares})`,
      html: `
        <div style="font-family: sans-serif; padding: 20px; border: 1px solid #4caf50;">
          ...
          <p><strong>${userName}</strong> clicked the share button on your website.</p>
          <hr>
